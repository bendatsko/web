  ...
  return (
    <>
      <div className={`${style.name} centerAlign`}>
        ...
        <div className="centerAlign box" style={{ marginTop: '-1.5rem' }}>
          <FlexboxGrid>
        ...
        >
          ...
          {siteMetadata.location
            ? (
                  <div style={{marginTop: '-.5rem', marginBottom: '-.5rem'}}><IconListItem icon="map-marker-alt" title={siteMetadata.location} /></div>
            ) : null}
          {siteMetadata.email
            ? (
