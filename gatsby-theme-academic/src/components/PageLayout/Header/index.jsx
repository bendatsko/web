...
import { ReactComponent as HamburgerIcon } from './bars-solid.svg';
      ...
      <Header>
        ...
        >
          <div className={`${style.hamburger} ${menu ? style.menuIcon : null}`}>
            ...
            <div className={style.line} />
            <div className={style.hamburgerText}>≡</div>
          </div>
        </div>
        ...
        >
          <div className={style.backgroundDiv}>
            <ul className={style.nav}>
              ...
              <NavButton to="/projects/" onClick={toggleMenu} partiallyActive>Projects</NavButton>
              <NavButton to="/research/" onClick={toggleMenu} partiallyActive>Research</NavButton>
              <li className={style.navItem} >
                <ThemeModeSwitch id="themeswitch"/>
              </li>
              <li className={style.navItem} id='searchBar'>
                <LoadableSearch
                  style={{ color: '#575757' }}
                ...
                />
                {isSearchBarExpanded ? (
                  <Icon icon="times" style={{ cursor: "pointer" }}/>
                ) : (
                  <Icon icon="search" style={{ cursor: "pointer", marginLeft: ".5rem"}} onMouseDown={toggleSearchIconClick} id="searchico" />
                )}
              </li>
